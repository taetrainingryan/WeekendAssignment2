...
public class PopAdapterDelegate extends AdapterDelegate<List<TrackDetails>> {

    private LayoutInflater layoutInflater;

    public PopAdapterDelegate(Activity activity) {
    ...
    protected void onBindViewHolder(@NonNull final List<TrackDetails> items, final int position, @NonNull RecyclerView.ViewHolder holder, @NonNull List<Object> payloads) {
        ...
        ((RockAdapterDelegate.MyViewHolder) holder).itemView.setOnClickListener(new View.OnClickListener() {
            @Override
